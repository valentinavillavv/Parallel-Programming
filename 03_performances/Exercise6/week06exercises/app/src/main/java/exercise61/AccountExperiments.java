...
public class AccountExperiments {
  ...
  // Create empty accounts
    ...
    //insert code using Mark7 to measure execution time
     // insert code using Mark7 to measure execution time
    Benchmark.Mark7("Execution time low transaction",
      i -> doNTransactions(1));
    Benchmark.Mark7("Execution time high transaction", 
      i -> doNTransactions(50));
  }
  ...
  static class Transaction {
    ...
    public void transfer(){
      ...
      try{Thread.sleep(60);} catch(Exception e){}; // Simulate transaction time
